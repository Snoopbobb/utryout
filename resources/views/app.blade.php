...
<body>	
	...
	<footer>
		...
		<h6><a href="https://www.facebook.com/utryout?fref=ts" style="color: white;" target="_blank">Like Us On <i class="fa fa-facebook"></i>acebook!</a></h6>
		<h6>A <a href="http://snoopbobb.com" style="color: white;" target="_blank">Snoopbobb</a> Application &copy;{{ date('Y') }}</h6>
	</footer>
